...
console.log( sumarNNumeros( 2, 3, 6, 5 ) ); // Pinta 16
...
function esPar( theNumber ) {

  // Esta funcion comprueba la paridad del numero pasado como parametro

  if( theNumber % 2 == 0 ) // Es par
  {
    return true;
  }
  else
...
if( esPar( 23 ) ) {
  console.log("Bieeeen, tengo años pareeeees! Qué puta ilusióoooon!");
}
else
{
  console.log("Puta mierda de vida, que mi edad es impar =(");
}
